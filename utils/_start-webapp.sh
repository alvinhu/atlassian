...
JAVA_OPTS="-javaagent:/opt/atlassian/atlassian-agent-1.3.1-bitbucket.jar -classpath $INST_DIR/app $JAVA_OPTS $BITBUCKET_ARGS $JMX_OPTS $JVM_REQUIRED_ARGS $JVM_SUPPORT_RECOMMENDED_ARGS"
